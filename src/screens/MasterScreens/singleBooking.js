          ...
          <div className="transporterbookedCar">
              ...
              <div style={{ width: "500px" }}>
                <div style={{ marginTop: "40px" }}>
                  ...
                  <div>
                    <h5>
                      <span style={{ fontWeight: "600" }}>Drop-off Date:</span>{" "}
                      {data.selectedDate}
                    </h5>
                    {/* <h5>Booking Type: {data.bookingType}</h5> */}
                  </div>
                  <div>
                    <h5>
                      <span style={{ fontWeight: "600" }}>Transporter id:</span>{" "}
                      {data.userid}
                    </h5>
                    {/* <h5>Booking Type: {data.bookingType}</h5> */}
                  </div>
                  <div>
                    <h5>
                      <span style={{ fontWeight: "600" }}>Transporter Name:</span>{" "}
                      {data.userName}
                    </h5>
                    {/* <h5>Booking Type: {data.bookingType}</h5> */}
                  </div>
                  <div>
                    <h5>
                      <span style={{ fontWeight: "600" }}>Customer Booking id:</span>{" "}
